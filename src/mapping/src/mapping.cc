...
void OccGridMap::updateMap(const Eigen::Vector3d& sensor_p,
  ...
  // map: [-size_x / 2, size_x / 2], [-size_y / 2, size_y / 2]
  // offset: idx distance between current camera and map yuandian
  // offset_x, offset_y, offset_z: distance between last camera and current camera 
