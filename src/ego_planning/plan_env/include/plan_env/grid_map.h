...
struct MappingData {
  ...
  Eigen::Vector3d laser_pos_, last_laser_pos_;
  ...
  // TODO: laser point cloud segmented by unstructured road
  vector<Eigen::Vector3d> seg_points_;
  int seg_points_cnt;
...
private:
  ...
  // get laser point cloud and laser pose
  ...
  void cloudCallbackTmp(const sensor_msgs::PointCloud2ConstPtr& img);
  void odomCallbackTmp(const nav_msgs::OdometryConstPtr &odom);
  void odomCallback(const nav_msgs::OdometryConstPtr& odom);

  // update occupancy by raycasting
  void updateImageOccupancyCallback(const ros::TimerEvent& /*event*/);
  void updateLaserOccupancyCallback(const ros::TimerEvent& /*event*/);
